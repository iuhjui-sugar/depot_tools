    ...
    def CMDPatchWithParsedIssue(self, parsed_issue_arg, nocommit, force):
        ...
        if force:
            ...
            print(
                ...
                'that is different from the one uploaded to Gerrit. If patched '
                'CL is not yours and you cannot upload new patches to it, you '
                'will also not be able to upload any stacked changes you '
                'create on top of this branch.\n'
