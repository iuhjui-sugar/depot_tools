...
&mdash; **def [add\_message](/recipes/recipe_modules/gerrit/api.py#320)(self, host: str, change: int, message: str, revision: (str | int)='current', name: str=None, step_test_data: (Callable[([], StepTestData)] | None)=None):**
...
&mdash; **def [move\_changes](/recipes/recipe_modules/gerrit/api.py#356)(self, host, project, from_branch, to_branch, step_test_data=None):**
...
&mdash; **def [update\_files](/recipes/recipe_modules/gerrit/api.py#380)(self, host, project, branch, new_contents_by_file_path, commit_msg, params=frozenset(['status=NEW']), cc_list=frozenset([]), submit=False, submit_later=False, step_test_data_create_change=None, step_test_data_submit_change=None):**
