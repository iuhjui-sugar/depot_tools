...
&mdash; **def [deapply\_patch](/recipes/recipe_modules/bot_update/api.py#681)(self, bot_update_result):**
...
&mdash; **def [get\_project\_revision\_properties](/recipes/recipe_modules/bot_update/api.py#658)(self, project_name, gclient_config=None):**
...
&mdash; **def [resolve\_fixed\_revision](/recipes/recipe_modules/bot_update/api.py#609)(self, bot_update_result, name):**

Sets a fixed revision for a single dependency using project revision
properties.

&mdash; **def [step\_name](/recipes/recipe_modules/bot_update/api.py#698)(self, patch, suffix):**
