...
def git_postprocess(template):
    ...
    call_if_outdated(os.path.join(template.GIT_BIN_ABSDIR, '.git_postprocess'),
...
def main(argv):
    ...
    if IS_WIN:
        ...
        template._replace(GIT_BIN_ABSDIR=git_directory,
                          GIT_BIN_ABSDIR_UNIX=posixpath.abspath(git_directory))
