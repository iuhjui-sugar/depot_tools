...
def search_win_git_directory():
    ...
    As depot_tools will soon stop bundling Git for Windows, this function prints
...
def main(argv):
    ...
    if IS_WIN:
        ...
        template = template._replace(
            GIT_BIN_ABSDIR=git_dir,
            GIT_BIN_ABSDIR_UNIX=pathlib.PureWindowsPath(git_dir).as_posix(),
        )
